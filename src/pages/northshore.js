    ...
    return (
      <div>
        <h2 className="major">Start in NorthShore</h2>
          ...
          <p>However as East Auckland will grow and dwellers of places like Torbay or Orewa live very far, it makes sense to open a new associated team up North.</p>
          ...
          <ul>
            ...
            <li><a href="https://www.facebook.com/East-Auckland-Eagles-HMB-1638528559544108/">East Auckland Eagles</a></li>
          </ul>
        </div>
    )
  }
