  ...
  render() {
    ...
    return (
      <div id="main" style={this.props.timeout ? {display: 'flex'} : {display: 'none'}}>
        ...
        <article id="buhurt" className={`${this.props.article === 'buhurt' ? 'active' : ''} ${this.props.articleTimeout ? 'timeout' : ''}`} style={{display:'none'}}>
          <h2 className="major">Buhurt</h2>
          <span className="image main"><img src={pic01} alt="" /></span>
          <p>TODO wall of pictures and image that illustrate basic rules and combat style of buhurt</p>
          <p>TODO explain the historical part of the sport</p>
          <p>TODO explain basic strategies</p>
        ...
        <article id="nz" className={`${this.props.article === 'nz' ? 'active' : ''} ${this.props.articleTimeout ? 'timeout' : ''}`} style={{display:'none'}}>
          ...
          <p>TODO present the teams, and how to contact them</p>
